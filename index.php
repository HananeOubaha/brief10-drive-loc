    ...
    <div class="w-4/5 mx-auto flex justify-center">
        <form method="post" action="" class="w-[45%] relative z-10 bg-white/20 backdrop-blur-lg p-8 rounded-lg shadow-lg text-center">
            ...
            <button type="submit" name="LogIn" 
                class="w-full bg-blue-500 hover:bg-blue-700 text-white font-medium py-2 rounded-lg transition duration-300">
                Se connecter
            </button>

            <p class="mt-6">
                Pas encore inscrit ? 
                <a href="inscription.php" class="text-blue-500 hover:underline">Inscrivez-vous ici</a>
            </p>
        </form>
    </div>
</body>
